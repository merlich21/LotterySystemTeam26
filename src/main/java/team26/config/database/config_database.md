Database Config:
 1) Запуск миграции 2 способа:
    - mvn flyway:migrate "-Dflyway.url=jdbc:postgresql://localhost:7432/lottery_db" "-Dflyway.user=postgres" "-Dflyway.password=postgres"-->
    - запустить main.
...
6) phone - строка, прринимает 12 чисел от 0 до 9, уникальный.
...
#### Ограничения (Constraints):
    ...
    - check_email_valid - email должен быть валидный.
